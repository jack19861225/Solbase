...
public class HBaseClient {
  ...
  // probably should make this thread pool size configurable via property file or so
  protected final PoolMap<ConnectionId, Connection> connections = new PoolMap<ConnectionId, Connection>(PoolType.RoundRobin, 100);
  ...
  protected static AtomicInteger currentTotal = new AtomicInteger(0);
  /**
